...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                .cors(Customizer.withDefaults()) // Dùng config từ corsConfigurationSource
                .csrf().disable() // Tắt CSRF nếu dùng REST API
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/**").permitAll() // Cho phép truy cập public
                        .anyRequest().authenticated() // Các route khác cần auth
                )
